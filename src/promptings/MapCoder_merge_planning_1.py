...
class MapCoder(BaseStrategy):
    ...
    def run_single_pass(self, item: dict):
        ...
        for example_no, example in enumerate(response["problem"], start=1):
            ...
            plannign_verification_prompt = agents.merge_planning_verification_agent_prompt(planning)
            ...
            plannings += f"planning id: {example_no}" + verification_res + "\n\n"

        merge_single_planning_name = "Merge single planning"
        merge_single_planning_prompt = agents.merge_single_planning_agent_prompt(plannings)
        ...
        agents.get_output(merge_single_planning_name, merged_plan)
