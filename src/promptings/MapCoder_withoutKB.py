# Without knowledge retrieval agent, t = 15 and t =  5 
...
class MapCoder(BaseStrategy):
    ...
    def run_single_pass(self, item: dict):
        ...
        for planning_with_ex in plannings:
            ...
            # Experimental Setup: t = 5, k = 3
            # Objective:
            # We aim to test whether the drop in the correct rate is caused by:
            # 1. The absence of the KB Agent, which eliminates the retrieval of relevant examples.
            # 2. The reduced number of trials due to the absence of the KB Agent. Without the KB Agent,
            #    the maximum number of trials decreases from k * t = 15 (with KB Agent) to t = 5 (without KB Agent).
            self.t = 15
